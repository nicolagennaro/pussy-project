...
def train_generator(seqs, users_pool, n_movies, left_out, kept):
	...
	while(True):
		...
		user_movies_y = seqs[ user ][ s_len - left_out : s_len - left_out + kept ]
...
def append_to_dict(d, stat, left_out, top_from):
