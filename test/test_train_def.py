...
steps_per_epoch = users_train.shape[0]		    	# a sweep of the 'whole' training set
validation_steps = int(users_train.shape[0]/10)		# this is used for validation during the training
